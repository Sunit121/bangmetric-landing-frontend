...
export default function Hero({
  ...
  if (pathname === "/strategic-portfolio-management") {
   ...
   else if (pathname === "/third-party-risk-management") {
    defaultBanner = "/images/third_party_risk_management_banner.png";
  }
  ...
  return (
    <section className="w-full flex justify-center pt-28 md:pt-24 lg:pt-28">
      <div className="w-full mx-auto px-4 md:px-8 pb-0 relative z-20">
